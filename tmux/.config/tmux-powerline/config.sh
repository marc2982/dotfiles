...
# The theme to use.
export TMUX_POWERLINE_THEME="marc"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/marc/.mail/inbox/new"

## mbox
# Path to the mbox to check.
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/marc"

## mailcheck
# Optional path to mailcheckrc
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/marc/.mailcheckrc"
# }
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/marc/.now_playing.log"
...
export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/marc/.tmux/plugins//tmux-continuum"
# }
...
export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PREFIX="Continuum: "
# }
